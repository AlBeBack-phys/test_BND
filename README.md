...
## Пути для улучшения полученного результата:
   ...
   - Если мы реализовываем детекцию для конкретных камер и ракурсов, можно с помощью идеи transfer learning дообучить модель на данные с наших камер. Это поможет модели лучше подстраиваться под особенности нашей местности и ракурса;
